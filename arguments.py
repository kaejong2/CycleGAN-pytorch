...
class Arguments:
    def __init__(self):
        ...
        self._parser.add_argument('--lr', type=float, default=1e-3, help='Float value for learning rate.')
        self._parser.add_argument('--root_path', type=str, default='/mnt/hdd_10tb_1/LJJ/DCGAN/', help='Checkpoint path.')
        self._parser.add_argument('--ckpt_path', type=str, default='/mnt/hdd_10tb_1/LJJ/DCGAN/save/checkpoints/', help='Checkpoint path.')
